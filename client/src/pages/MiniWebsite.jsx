...
const MiniWebsite = () => {
            ...
            <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#F8FAFC', padding: '20px' }}>
                <div style={{ textAlign: 'center', background: 'white', padding: '48px', borderRadius: '40px', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.1)', maxWidth: '500px' }}>
                    ...
                    <button 
                        ...
                        style={{ width: '100%', height: '56px', borderRadius: '16px', background: '#4F46E5', color: '#2D3748', border: 'none', fontWeight: 800, cursor: 'pointer' }}
                    >
    ...
    const getSectorColor = (name) => {
        ...
        if (n.includes('automotive') || n.includes('car')) return '#5A315D';
        if (n.includes('wellness') || n.includes('fitness') || n.includes('gym')) return '#5A315D';
    ...
    return (
        <div style={{ background: '#F8FAFC', minHeight: '100vh', scrollBehavior: 'smooth', overflowY: 'auto' }}>
            {/* 🔝 PREMIUM NAVIGATION */}
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <div style={{ fontSize: '18px', fontWeight: 900, color: '#2D3748', lineHeight: 1 }}>{org.organizationName || org.name}</div>
                                    {org.plan?.type === 'paid' && (
                                        <div title="Verified Premium Partner" style={{ background: '#6366F1', color: '#2D3748', padding: '2px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <ShieldCheck size={12} />
                                        </div>
                                    )}
                                </div>
                        ...
                        {!isOwner && (
                            <div style={{ display: 'flex', gap: '12px' }}>
                                ...
                                <button 
                                    ...
                                    style={{ 
                                        background: primaryColor, color: '#2D3748', border: 'none', padding: '12px 32px', 
            ...
            <main id="home" style={{ maxWidth: '1400px', margin: '0 auto', padding: '40px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '40px', marginBottom: '80px', alignItems: 'center' }}>
                    ...
                    >
                        ...
                        <h1 style={{ fontSize: '72px', fontWeight: 950, color: '#2D3748', lineHeight: 1.1, marginBottom: '24px', letterSpacing: '-3px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '20px' }}>
                            <button 
                                onClick={() => navigate(`/book?clientId=${id}`)}
                                style={{ 
                                    background: primaryColor, color: '#2D3748', border: 'none', height: '72px', 
                            ...
                            <button onClick={() => document.getElementById('about').scrollIntoView({ behavior: 'smooth' })} style={{ background: 'white', color: '#2D3748', border: '1px solid #E2E8F0', height: '72px', padding: '0 32px', borderRadius: '24px', fontSize: '16px', fontWeight: 800, cursor: 'pointer' }}>
                                View Services
                            </button>
                        </div>
                        ...
                        <div style={{ marginTop: '56px', display: 'flex', alignItems: 'center', gap: '32px' }}>
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <span style={{ fontSize: '28px', fontWeight: 900, color: '#2D3748' }}>5k+</span>
                                <span style={{ fontSize: '13px', color: '#64748B', fontWeight: 700 }}>Happy Clients</span>
                            </div>
                            <div style={{ width: '1px', height: '40px', background: '#E2E8F0' }} />
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <span style={{ fontSize: '28px', fontWeight: 900, color: '#2D3748' }}>12+</span>
                    ...
                    >
                        <div style={{ 
                            ...
                            <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                                <div style={{ background: '#F0FDF4', color: '#5A315D', padding: '12px', borderRadius: '16px' }}><CheckCircle2 size={24} /></div>
                                <div>
                                    <div style={{ fontWeight: 900, fontSize: '14px', color: '#2D3748' }}>Slots Available Today</div>
                                    <div style={{ fontSize: '12px', color: '#718096', fontWeight: 600 }}>Book in 60 seconds</div>
                                </div>
                            </div>
                            {/* Lottie Animation 1 - Appointment Booking */}
                                <LottieWrapper url="https://assets3.lottiefiles.com/packages/lf20_q5pk6p1k.json" style={{ width: '100%', height: '100%' }} fallbackIcon={Clock} />
                        </div>
                        <img 
                ...
                <div id="about" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', marginBottom: '120px', alignItems: 'center' }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        />
                        <div style={{ position: 'absolute', bottom: '-30px', right: '-30px', width: '250px', background: primaryColor, padding: '40px', borderRadius: '30px', color: '#2D3748', boxShadow: `0 20px 40px ${primaryColor}40` }}>
                    ...
                    <div>
                        <h2 style={{ fontSize: '48px', fontWeight: 900, color: '#2D3748', marginBottom: '32px', letterSpacing: '-1.5px' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                            {[
                                ...
                                <div key={i} style={{ display: 'flex', gap: '16px' }}>
                                    ...
                                    <div>
                                        <div style={{ fontWeight: 800, color: '#2D3748', fontSize: '15px' }}>{feat.title}</div>
                ...
                <section id="team" style={{ marginBottom: '120px' }}>
                    <div style={{ textAlign: 'center', marginBottom: '64px' }}>
                        ...
                        <h2 style={{ fontSize: '56px', fontWeight: 900, color: '#2D3748', letterSpacing: '-2px' }}>Meet Our {config.dashboard.employeeRole}s</h2>
                    </div>
                ...
                <section id="services" style={{ marginBottom: '120px' }}>
                    <div style={{ background: '#FFFFFF', borderRadius: '60px', padding: '100px 60px', color: '#2D3748' }}>
                        <div style={{ textAlign: 'center', marginBottom: '80px' }}>
                            <h2 style={{ fontSize: '56px', fontWeight: 900, marginBottom: '16px', letterSpacing: '-2px' }}>Professional Catalog</h2>
                            <p style={{ fontSize: '18px', color: '#718096', maxWidth: '600px', margin: '0 auto' }}>Select the perfect service for your needs. All services are performed by our certified team.</p>
                        </div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))', gap: '32px' }}>
                            {(services.length > 0 ? services : [
                                ...
                                <div key={srv._id} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(90, 49, 93, 0.1)', padding: '40px', borderRadius: '40px', position: 'relative', overflow: 'hidden' }}>
                                    {srv.dummy && org.plan?.type !== 'paid' && <div style={{ position: 'absolute', top: '16px', left: '16px', background: 'rgba(90, 49, 93, 0.1)', color: '#718096', fontSize: '11px', fontWeight: 800, padding: '4px 10px', borderRadius: '12px' }}>Demo Service</div>}
                                    <div style={{ position: 'absolute', top: 0, right: 0, background: primaryColor, color: '#2D3748', padding: '8px 24px', fontSize: '12px', fontWeight: 900, borderBottomLeftRadius: '20px' }}>Rs. {srv.price}</div>
                                    <h3 style={{ fontSize: '24px', fontWeight: 900, marginBottom: '12px' }}>{srv.name}</h3>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#718096', fontSize: '13px', fontWeight: 700, marginBottom: '24px' }}>
                                        <Clock size={16} /> {srv.duration} Minutes Session
                                    </div>
                                    <p style={{ color: '#718096', lineHeight: 1.6, marginBottom: '32px', fontSize: '15px' }}>{srv.description || 'Our signature high-performance service tailored to deliver maximum value and professional results.'}</p>
                                    <button onClick={() => navigate(`/book?clientId=${id}`)} style={{ width: '100%', height: '60px', borderRadius: '20px', background: 'white', color: '#2D3748', border: 'none', fontWeight: 900, fontSize: '16px', cursor: 'pointer', transition: '0.2s' }} onMouseOver={e => e.currentTarget.style.transform = 'scale(1.02)'} onMouseOut={e => e.currentTarget.style.transform = 'scale(1)'}>Book This Service</button>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section style={{ marginBottom: '120px' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '0.8fr 1.2fr', gap: '80px', alignItems: 'center' }}>
                        <div>
                            <h2 style={{ fontSize: '48px', fontWeight: 900, color: '#2D3748', marginBottom: '24px', letterSpacing: '-1.5px' }}>What Our Clients Are Saying</h2>
                            ...
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ fontSize: '40px', fontWeight: 900, color: '#2D3748' }}>4.9</div>
                                <div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                            {[
                                ...
                                <div key={i} style={{ background: 'white', padding: '32px', borderRadius: '32px', border: '1px solid #E2E8F0' }}>
                                    ...
                                    <div style={{ fontWeight: 900, fontSize: '14px', color: '#2D3748' }}>- {t.name}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div id="contact" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', background: 'white', borderRadius: '60px', overflow: 'hidden', border: '1px solid #E2E8F0', marginBottom: '120px' }}>
                    <div style={{ padding: '80px' }}>
                        <h2 style={{ fontSize: '40px', fontWeight: 900, marginBottom: '48px', color: '#2D3748' }}>Get in Touch</h2>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
                            <div style={{ display: 'flex', gap: '24px' }}>
                                ...
                                <div>
                                    <div style={{ fontSize: '12px', fontWeight: 900, color: '#718096', letterSpacing: '1px', marginBottom: '8px' }}>OUR LOCATION</div>
                                    <div style={{ fontSize: '18px', fontWeight: 700, color: '#2D3748' }}>{org.address || 'Chennai, Tamil Nadu, India'}</div>
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: '24px' }}>
                                ...
                                <div>
                                    <div style={{ fontSize: '12px', fontWeight: 900, color: '#718096', letterSpacing: '1px', marginBottom: '8px' }}>PHONE NUMBER</div>
                                    <div style={{ fontSize: '18px', fontWeight: 700, color: '#2D3748' }}>{org.phone || '+91 98765 43210'}</div>
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: '24px' }}>
                                ...
                                <div>
                                    <div style={{ fontSize: '12px', fontWeight: 900, color: '#718096', letterSpacing: '1px', marginBottom: '8px' }}>SUPPORT EMAIL</div>
                                    <div style={{ fontSize: '18px', fontWeight: 700, color: '#2D3748' }}>{org.email || 'care@organization.com'}</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer style={{ background: '#FFFFFF', padding: '100px 40px 40px', color: '#2D3748' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr', gap: '60px', marginBottom: '100px' }}>
                        <div>
                             <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '32px' }}>
                                <div style={{ background: 'white', color: '#2D3748', padding: '10px', borderRadius: '12px' }}><Building2 size={24} /></div>
                                <span style={{ fontSize: '24px', fontWeight: 900 }}>{org.organizationName || org.name}</span>
                            </div>
                            <p style={{ color: '#718096', lineHeight: 1.8, fontSize: '15px' }}>Providing excellence in {org.sector} with a commitment to quality, trust, and professional integrity. Book your appointment today.</p>
                        </div>
                        <div>
                            <h4 style={{ fontWeight: 900, marginBottom: '32px', fontSize: '14px', letterSpacing: '1px' }}>QUICK LINKS</h4>
                            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px', color: '#718096', fontSize: '15px', fontWeight: 600 }}>
                                <li>Meet the Team</li>
...
const FloatingSupport = ({ color }) => (
    ...
    >
        <button style={{ 
            ...
            background: color, 
            border: 'none', color: '#2D3748', display: 'flex', 
