            ...
            <div className="login-form-side" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px', background: '#F8FAFC' }}>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} style={{ width: '100%', maxWidth: '440px', background: 'white', padding: '48px', borderRadius: '32px', boxShadow: '0 20px 50px rgba(0,0,0,0.06)' }}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                        <div style={{ background: '#6366F1', width: '52px', height: '52px', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#2D3748', margin: '0 auto 20px', boxShadow: '0 10px 20px rgba(99,102,241,0.3)' }}>
                            <LogIn size={24} />
                        </div>
                        <h2 style={{ fontSize: '30px', fontWeight: 900, color: '#2D3748', marginBottom: '8px' }}>Welcome Back</h2>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <Mail size={18} style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', color: '#718096' }} />
                        ...
                        <div style={{ marginBottom: '28px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <Lock size={18} style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', color: '#718096' }} />
                        ...
                        <button type="submit" disabled={loading} style={{ 
                            width: '100%', height: '56px', borderRadius: '16px', background: '#6366F1', color: '#2D3748', 
                    ...
                    <div style={{ marginTop: '32px', textAlign: 'center', borderTop: '1px solid #F1F5F9', paddingTop: '24px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '12px' }}>
                            <Link to="/register?role=user" style={{ 
                                ...
                                color: '#2D3748', fontWeight: 800, fontSize: '14px', textDecoration: 'none', 
                        ...
                        <p style={{ fontSize: '12px', color: '#718096', marginTop: '12px' }}>🎁 Business owners get <strong style={{ color: '#6366F1' }}>1 Day Free Trial</strong></p>
                    </div>
                </motion.div>
            </div>

            {/* RIGHT - INFO PANEL */}
            <div className="login-side-panel" style={{ flex: 1, background: 'linear-gradient(135deg, #6366F1, #4F46E5)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#2D3748', padding: '80px', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ maxWidth: '420px', position: 'relative', zIndex: 1 }}>
                    <div style={{ background: 'rgba(90, 49, 93, 0.15)', padding: '8px 20px', borderRadius: '100px', display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '32px', fontSize: '13px', fontWeight: 800 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '40px' }}>
                        <div style={{ background: 'rgba(90, 49, 93, 0.1)', padding: '24px', borderRadius: '20px', backdropFilter: 'blur(10px)' }}>
                    ...
                    <div style={{ display: 'flex', gap: '32px', marginTop: '48px' }}>
                        ...
                        <div style={{ width: '1px', background: 'rgba(90, 49, 93, 0.2)' }} />
